...
const TypeBubble = ({
    ...
    return (
        ...
        >
            ...
            <div
                className={`relative max-w-[80%] rounded-[15px] px-4 py-3 text-[15px] cursor-pointer transition-all duration-300 ${msg.from === "pablo"
        ...
        if (step.from === "pablo") {
            ...
            setTimeout(() => {
                ...
                if (step.text.startsWith("compare them")) {
                    // scroll to this div
                    scrollRefCompare.current?.scrollIntoView({ behavior: 'smooth' });
                }
            ...
            const userDelay = 1500 / playbackSpeed;
            setTimeout(() => {
                playMessageSound();
                setMsgs(prev => [...prev, { from: step.from, text: step.text }]);
                setIsTypingMessage(true);
